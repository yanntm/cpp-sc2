...
class UnitTypeData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SC2APIProtocol.UnitTypeData) */ {
 ...
 private:
  ...
  inline void set_has_sight_range();
  inline void clear_has_sight_range();
...
class EffectData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SC2APIProtocol.EffectData) */ {
 public:
  EffectData();
  virtual ~EffectData();
