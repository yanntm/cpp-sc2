...
void protobuf_AssignDesc_s2clientprotocol_2fdata_2eproto() {
  ...
  static const int UnitTypeData_offsets_[22] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UnitTypeData, sight_range_),
  ...
  BuffData_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1);
  EffectData_descriptor_ = file->message_type(6);
  static const int EffectData_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EffectData, effect_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EffectData, name_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EffectData, friendly_name_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EffectData, radius_),
  };
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[8 / 32] & 48896u) {
    ...
    ZR_(sight_range_, unit_alias_);
  }
  if (_has_bits_[16 / 32] & 1769472u) {
    ZR_(tech_requirement_, movement_speed_);
    require_attached_ = false;
    armor_ = 0;
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 24: {
        ...
        if (input->ExpectTag(205)) goto parse_sight_range;
        break;
      }
...
void UnitTypeData::InternalSwap(UnitTypeData* other) {
  ...
  std::swap(sight_range_, other->sight_range_);
...
// optional float sight_range = 25;
bool UnitTypeData::has_sight_range() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
void UnitTypeData::set_has_sight_range() {
  _has_bits_[0] |= 0x00002000u;
}
void UnitTypeData::clear_has_sight_range() {
  _has_bits_[0] &= ~0x00002000u;
}
void UnitTypeData::clear_sight_range() {
  sight_range_ = 0;
  clear_has_sight_range();
}
 float UnitTypeData::sight_range() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.UnitTypeData.sight_range)
  return sight_range_;
}
 void UnitTypeData::set_sight_range(float value) {
  set_has_sight_range();
  sight_range_ = value;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:SC2APIProtocol.EffectData)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_friendly_name;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:SC2APIProtocol.EffectData)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:SC2APIProtocol.EffectData)
  return false;
#undef DO_
}
...
void EffectData::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:SC2APIProtocol.EffectData)
  // optional uint32 effect_id = 1;
  if (has_effect_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:SC2APIProtocol.EffectData)
}
...
// optional uint32 effect_id = 1;
bool EffectData::has_effect_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void EffectData::set_has_effect_id() {
  _has_bits_[0] |= 0x00000001u;
}
void EffectData::clear_has_effect_id() {
  _has_bits_[0] &= ~0x00000001u;
}
void EffectData::clear_effect_id() {
  effect_id_ = 0u;
  clear_has_effect_id();
}
 ::google::protobuf::uint32 EffectData::effect_id() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.EffectData.effect_id)
  return effect_id_;
}
 void EffectData::set_effect_id(::google::protobuf::uint32 value) {
  set_has_effect_id();
  effect_id_ = value;
...
// optional string name = 2;
bool EffectData::has_name() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void EffectData::set_has_name() {
  _has_bits_[0] |= 0x00000002u;
}
void EffectData::clear_has_name() {
  _has_bits_[0] &= ~0x00000002u;
}
void EffectData::clear_name() {
  name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_name();
}
 const ::std::string& EffectData::name() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.EffectData.name)
  return name_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void EffectData::set_name(const ::std::string& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:SC2APIProtocol.EffectData.name)
}
 void EffectData::set_name(const char* value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:SC2APIProtocol.EffectData.name)
}
 void EffectData::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:SC2APIProtocol.EffectData.name)
}
 ::std::string* EffectData::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:SC2APIProtocol.EffectData.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* EffectData::release_name() {
  // @@protoc_insertion_point(field_release:SC2APIProtocol.EffectData.name)
  clear_has_name();
  return name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void EffectData::set_allocated_name(::std::string* name) {
  if (name != NULL) {
    set_has_name();
  } else {
    clear_has_name();
...
// optional string friendly_name = 3;
bool EffectData::has_friendly_name() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
void EffectData::set_has_friendly_name() {
  _has_bits_[0] |= 0x00000004u;
}
void EffectData::clear_has_friendly_name() {
  _has_bits_[0] &= ~0x00000004u;
}
void EffectData::clear_friendly_name() {
  friendly_name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_friendly_name();
}
 const ::std::string& EffectData::friendly_name() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.EffectData.friendly_name)
  return friendly_name_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void EffectData::set_friendly_name(const ::std::string& value) {
  set_has_friendly_name();
  friendly_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:SC2APIProtocol.EffectData.friendly_name)
}
 void EffectData::set_friendly_name(const char* value) {
  set_has_friendly_name();
  friendly_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:SC2APIProtocol.EffectData.friendly_name)
}
 void EffectData::set_friendly_name(const char* value, size_t size) {
  set_has_friendly_name();
  friendly_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:SC2APIProtocol.EffectData.friendly_name)
}
 ::std::string* EffectData::mutable_friendly_name() {
  set_has_friendly_name();
  // @@protoc_insertion_point(field_mutable:SC2APIProtocol.EffectData.friendly_name)
  return friendly_name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 ::std::string* EffectData::release_friendly_name() {
  // @@protoc_insertion_point(field_release:SC2APIProtocol.EffectData.friendly_name)
  clear_has_friendly_name();
  return friendly_name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void EffectData::set_allocated_friendly_name(::std::string* friendly_name) {
  if (friendly_name != NULL) {
    set_has_friendly_name();
  } else {
    clear_has_friendly_name();
...
// optional float radius = 4;
bool EffectData::has_radius() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
void EffectData::set_has_radius() {
  _has_bits_[0] |= 0x00000008u;
}
void EffectData::clear_has_radius() {
  _has_bits_[0] &= ~0x00000008u;
}
void EffectData::clear_radius() {
  radius_ = 0;
  clear_has_radius();
}
 float EffectData::radius() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.EffectData.radius)
  return radius_;
}
 void EffectData::set_radius(float value) {
  set_has_radius();
  radius_ = value;
