...
void protobuf_AssignDesc_s2clientprotocol_2fdebug_2eproto() {
  ...
  static const int DebugCommand_offsets_[9] = {
  ...
  static const int DebugText_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DebugText, size_),
  };
...
// optional uint32 size = 5;
bool DebugText::has_size() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
void DebugText::set_has_size() {
  _has_bits_[0] |= 0x00000010u;
}
void DebugText::clear_has_size() {
  _has_bits_[0] &= ~0x00000010u;
}
void DebugText::clear_size() {
  size_ = 0u;
  clear_has_size();
}
 ::google::protobuf::uint32 DebugText::size() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.DebugText.size)
  return size_;
}
 void DebugText::set_size(::google::protobuf::uint32 value) {
  set_has_size();
  size_ = value;
