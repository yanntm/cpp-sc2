...
void protobuf_AssignDesc_s2clientprotocol_2fscore_2eproto() {
  ...
  static const int ScoreDetails_offsets_[28] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScoreDetails, current_apm_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScoreDetails, current_effective_apm_),
  };
...
const int ScoreDetails::kCurrentApmFieldNumber;
const int ScoreDetails::kCurrentEffectiveApmFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[24 / 32] & 251658240u) {
    ZR_(current_apm_, current_effective_apm_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 26: {
        ...
        if (input->ExpectTag(221)) goto parse_current_apm;
        break;
      }
      ...
      case 27: {
        ...
        if (input->ExpectTag(229)) goto parse_current_effective_apm;
        break;
      }
      ...
      case 28: {
        if (tag == 229) {
         parse_current_effective_apm:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
                 input, &current_effective_apm_)));
          set_has_current_effective_apm();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectAtEnd()) goto success;
...
void ScoreDetails::SerializeWithCachedSizes(
  ...
  // optional float current_apm = 27;
  if (has_current_apm()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(27, this->current_apm(), output);
  }

  // optional float current_effective_apm = 28;
  if (has_current_effective_apm()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(28, this->current_effective_apm(), output);
  }
...
::google::protobuf::uint8* ScoreDetails::InternalSerializeWithCachedSizesToArray(
  ...
  // optional float current_apm = 27;
  if (has_current_apm()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(27, this->current_apm(), target);
  }

  // optional float current_effective_apm = 28;
  if (has_current_effective_apm()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(28, this->current_effective_apm(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:SC2APIProtocol.ScoreDetails)
  ...
  if (from._has_bits_[24 / 32] & (0xffu << (24 % 32))) {
    ...
    if (from.has_current_apm()) {
      set_current_apm(from.current_apm());
    }
    if (from.has_current_effective_apm()) {
      set_current_effective_apm(from.current_effective_apm());
    }
  }
  if (from._internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->MergeFrom(from.unknown_fields());
...
void ScoreDetails::InternalSwap(ScoreDetails* other) {
  ...
  std::swap(current_apm_, other->current_apm_);
  std::swap(current_effective_apm_, other->current_effective_apm_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// optional float current_apm = 27;
bool ScoreDetails::has_current_apm() const {
  return (_has_bits_[0] & 0x04000000u) != 0;
}
void ScoreDetails::set_has_current_apm() {
  _has_bits_[0] |= 0x04000000u;
}
void ScoreDetails::clear_has_current_apm() {
  _has_bits_[0] &= ~0x04000000u;
}
void ScoreDetails::clear_current_apm() {
  current_apm_ = 0;
  clear_has_current_apm();
}
 float ScoreDetails::current_apm() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.ScoreDetails.current_apm)
  return current_apm_;
}
 void ScoreDetails::set_current_apm(float value) {
  set_has_current_apm();
  current_apm_ = value;
...
// optional float current_effective_apm = 28;
bool ScoreDetails::has_current_effective_apm() const {
  return (_has_bits_[0] & 0x08000000u) != 0;
}
void ScoreDetails::set_has_current_effective_apm() {
  _has_bits_[0] |= 0x08000000u;
}
void ScoreDetails::clear_has_current_effective_apm() {
  _has_bits_[0] &= ~0x08000000u;
}
void ScoreDetails::clear_current_effective_apm() {
  current_effective_apm_ = 0;
  clear_has_current_effective_apm();
}
 float ScoreDetails::current_effective_apm() const {
  // @@protoc_insertion_point(field_get:SC2APIProtocol.ScoreDetails.current_effective_apm)
  return current_effective_apm_;
}
 void ScoreDetails::set_current_effective_apm(float value) {
  set_has_current_effective_apm();
